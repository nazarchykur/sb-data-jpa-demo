...
/*
    ...
    Основні переваги використання паттерна DTO в Spring Boot:
        ...
        якщо DTO є імутабельним, то конструктор без параметрів не є обов'язковим, оскільки поля DTO не можуть бути
        змінені після створення об'єкта.

        Отже, основні правила використання паттерна DTO в Spring Boot:
            ...
            4. DTO повинен мати конструктор з параметрами для ініціалізації полів.
            5. DTO повинен мати гетери для доступу до полів.
